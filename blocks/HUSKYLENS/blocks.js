...
Blockly.Blocks['huskylens_algorithm'] = {
  init: function () {
    funclist = [
      [Blockly.Msg.HL_ALGORITHM_FACE_RECOGNITION, 'ALGORITHM_FACE_RECOGNITION'],
      [Blockly.Msg.HL_ALGORITHM_OBJECT_TRACKING, 'ALGORITHM_OBJECT_TRACKING'],
      [Blockly.Msg.HL_ALGORITHM_OBJECT_RECOGNITION, 'ALGORITHM_OBJECT_RECOGNITION'],
      [Blockly.Msg.HL_ALGORITHM_LINE_TRACKING, 'ALGORITHM_LINE_TRACKING'],
      [Blockly.Msg.HL_ALGORITHM_COLOR_RECOGNITION, 'ALGORITHM_COLOR_RECOGNITION'],
      [Blockly.Msg.HL_ALGORITHM_TAG_RECOGNITION, 'ALGORITHM_TAG_RECOGNITION'],
      [Blockly.Msg.HL_ALGORITHM_OBJECT_CLASSIFICATION, 'ALGORITHM_OBJECT_CLASSIFICATION']
    ];
    this.appendDummyInput()
