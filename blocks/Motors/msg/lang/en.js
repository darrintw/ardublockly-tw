...
Blockly.Msg.ARD_ULTRASONIC_DISTANCE = "HC-SR04 Setup";
Blockly.Msg.ARD_ULTRASONIC_DISTANCE_TIP = "";
Blockly.Msg.ARD_ULTRASONIC_DISTANCE_TRIG = "Trig";
Blockly.Msg.ARD_ULTRASONIC_DISTANCE_ECHO = "ECHO";
Blockly.Msg.ARD_ULTRASONIC_DISTANCE_CM = "cm";
Blockly.Msg.ARD_ULTRASONIC_DISTANCE_INCH = "inch";
Blockly.Msg.AFMOROT = 'L293D';
Blockly.Msg.AFMOROT_CONTROL = 'Command';
Blockly.Msg.AFMOROT_FORWARD = 'Forward';
Blockly.Msg.AFMOROT_BACKWARD = 'Backward';
Blockly.Msg.AFMOROT_RELEASE = 'Stop';
