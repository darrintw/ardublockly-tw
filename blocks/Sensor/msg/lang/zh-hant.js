...
Blockly.Msg.ARD_DHT11_READTEMP_MSG = " 的 DHT11 模組讀取攝氏溫度";
Blockly.Msg.ARD_DHT11_READTEMP_TIP = "從 DHT11 溫濕度模組取得整數攝氏溫度值, NAN 表示讀取錯誤";
Blockly.Msg.ARD_DHT11_READHUMI_FROM  = "從 ";
Blockly.Msg.ARD_DHT11_READHUMI_MSG = " 的 DHT11 模組讀取相對濕度";
Blockly.Msg.ARD_DHT11_READHUMI_TIP = "從 DHT11 溫濕度模組取得相對濕度值, NAN 表示讀取錯誤";
Blockly.Msg.ARD_DS18B20_READTEMP_FROM  = "從 ";
Blockly.Msg.ARD_DS18B20_READTEMP_MSG = " 的 DS18B20 感測器讀取攝氏溫度";
Blockly.Msg.ARD_DS18B20_READTEMP_TIP = "從 DS18B20 感測器取得攝氏溫度值, -127 表示讀取錯誤";
Blockly.Msg.ARD_PHOTOCELLS_READTEMP_FROM  = "從 ";
Blockly.Msg.ARD_PHOTOCELLS_READTEMP_MSG = " 的 光敏電阻 感測器讀取攝氏溫度";
Blockly.Msg.ARD_PHOTOCELLS_READTEMP_TIP = "從 光敏電阻 感測器取得攝氏溫度值, -1 表示讀取錯誤";